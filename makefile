...
EXT = c
CFLAGS = -O3 -std=c11 -Wshadow -Winit-self -Wredundant-decls -Wcast-align -Wfloat-equal -Wunreachable-code -Wmissing-declarations -Wmissing-include-dirs -Wmain -Wfatal-errors -Wextra -Wall -Wno-switch -Wno-unused-parameter -Wno-float-equal
